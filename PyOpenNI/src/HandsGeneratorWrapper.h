...
void __stdcall Create_callback(xn::HandsGenerator& src, XnUserID user, const XnPoint3D *pPosition, XnFloat fTime, void* cookie);
void __stdcall Update_callback(xn::HandsGenerator& src, XnUserID user, const XnPoint3D *pPosition, XnFloat fTime, void* cookie);
void __stdcall Destroy_callback(xn::HandsGenerator& src, XnUserID user, XnFloat fTime, void* cookie);
