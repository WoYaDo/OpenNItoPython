...
void __stdcall SkeletonCapability_CalibrationStart_cb(xn::SkeletonCapability &src, XnUserID user, void *cookie);

//This is used for both CalibrationInProgress and CalibrationCompleted
void __stdcall SkeletonCapability_CalibrationStatus_cb(xn::SkeletonCapability &src, XnUserID user, XnCalibrationStatus status, void *cookie);
