...
void __stdcall NewUser_callback(xn::UserGenerator& src, XnUserID user, void* cookie);
void __stdcall LostUser_callback(xn::UserGenerator& src, XnUserID user, void* cookie);
